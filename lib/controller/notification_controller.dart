...
import 'package:campus_plus/main.dart';
...
class NotificationController {
  ...
  static Future<void> onActionReceivedMethod(
    ...
    if (receivedAction.channelKey == "chats") {
      if (receivedAction.actionType == ActionType.SilentAction ||
        ...
        ChatController()
            .sendMessage(receivedAction.payload!['chatId']!, chatMessageData);
      } else {}
    }
    ...
    if (receivedAction.actionType == ActionType.SilentAction ||
      ...
      CampusPlus.navigatorKey.currentState?.pushNamedAndRemoveUntil(
          '/notification-page',
          (route) =>
  ...
  static Future<bool> displayNotificationRationale() async {
    ...
    BuildContext context = CampusPlus.navigatorKey.currentContext!;
    await showDialog(
        context: context,
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                const Text(
                    'Allow Campus+ to send you beautiful notifications!'),
              ],
            ),
            actions: [
              TextButton(
              ...
              TextButton(
                  ...
                  child: Text(
                    ...
                    style: Theme.of(context)
                        .textTheme
                        .titleLarge
                        ?.copyWith(color: AppColors.aubRed),
                  )),
            ],
          );
        });
